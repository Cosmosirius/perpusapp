...
<div class="container my-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                @if ($book->cover_image)
                    <img src="{{ asset('storage/' . $book->cover_image) }}" class="card-img-top img-fluid" alt="Cover Image">
                @else
        ...
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <form action="{{ route('books.destroy', $book->id) }}" method="POST" onsubmit="return confirm('Apakah anda yakin ?');" class="d-inline">
                            @csrf
                            @method('DELETE')
            ...
            <div class="text-muted small">
                <span>Created: {{ $book->created_at ? \Carbon\Carbon::parse($book->created_at)->diffForHumans() : '-' }}</span>
            </div>
        </div>
    </div>
</div>
